  ...
  (function() {
    ...
    isSVGElement = function(el) {
      ...
      if (typeof SVGElement !== "undefined" && SVGElement !== null && (typeof SVGSVGElement !== "undefined" && SVGSVGElement !== null)) {
        ...
        return (_ref = (_ref1 = dynamics2.tests) != null ? typeof _ref1.isSVG === "function" ? _ref1.isSVG(el) : void 0 : void 0) != null ? _ref : false;
      }
    };
    ...
    Matrix = function() {
      ...
      Matrix2.matrixForTransform = cacheFn(function(transform) {
        ...
        result = (_ref = (_ref1 = style.transform) != null ? _ref1 : style[propertyWithPrefix("transform")]) != null ? _ref : (_ref2 = dynamics2.tests) != null ? _ref2.matrixForTransform(transform) : void 0;
    ...
    dynamics2 = {};
    dynamics2.linear = function() {
      return function(t) {
        return t;
      };
    };
    dynamics2.spring = function(options) {
      var A1, A2, frequency, friction, s;
      if (options == null) {
        options = {};
      }
      applyDefaults(options, dynamics2.spring.defaults);
    ...
    dynamics2.bounce = function(options) {
      var A, fn, frequency, friction;
      if (options == null) {
        options = {};
      }
      applyDefaults(options, dynamics2.bounce.defaults);
      frequency = Math.max(1, options.frequency / 20);
      friction = Math.pow(20, options.friction / 100);
      A = function(t) {
        return Math.pow(friction / 10, -t) * (1 - t);
    ...
    dynamics2.gravity = function(options) {
      var L, bounciness, curves, elasticity, fn, getPointInCurve, gravity2;
      if (options == null) {
        options = {};
      }
      applyDefaults(options, dynamics2.gravity.defaults);
    ...
    dynamics2.forceWithGravity = function(options) {
      if (options == null) {
        options = {};
      }
      applyDefaults(options, dynamics2.forceWithGravity.defaults);
      options.returnsToSelf = true;
      return dynamics2.gravity(options);
    };
    dynamics2.bezier = function() {
    ...
    dynamics2.easeInOut = function(options) {
      var friction, _ref;
      if (options == null) {
        options = {};
      }
      friction = (_ref = options.friction) != null ? _ref : dynamics2.easeInOut.defaults.friction;
      return dynamics2.bezier({
        points: [
          {
            x: 0,
            y: 0,
    ...
    dynamics2.easeIn = function(options) {
      var friction, _ref;
      if (options == null) {
        options = {};
      }
      friction = (_ref = options.friction) != null ? _ref : dynamics2.easeIn.defaults.friction;
      return dynamics2.bezier({
        points: [
          {
            x: 0,
    ...
    dynamics2.easeOut = function(options) {
      var friction, _ref;
      if (options == null) {
        options = {};
      }
      friction = (_ref = options.friction) != null ? _ref : dynamics2.easeOut.defaults.friction;
      return dynamics2.bezier({
        points: [
          {
            x: 0,
    ...
    dynamics2.spring.defaults = {
      frequency: 300,
      friction: 200,
      anticipationSize: 0,
      anticipationStrength: 0
    };
    dynamics2.bounce.defaults = {
      frequency: 300,
      friction: 200
    };
    dynamics2.forceWithGravity.defaults = dynamics2.gravity.defaults = {
      bounciness: 400,
      elasticity: 200
    };
    dynamics2.easeInOut.defaults = dynamics2.easeIn.defaults = dynamics2.easeOut.defaults = {
      friction: 500
    };
    dynamics2.css = makeArrayFn(function(el, properties) {
      return applyProperties(el, properties, true);
    });
    dynamics2.animate = makeArrayFn(function(el, properties, options) {
      var id;
      if (options == null) {
        options = {};
      }
      ...
      if (options.delay === 0) {
        ...
        id = dynamics2.setTimeout(function() {
    ...
    dynamics2.stop = makeArrayFn(function(el, options) {
      if (options == null) {
        options = {};
      }
      ...
      if (options.timeout) {
        animationsTimeouts = animationsTimeouts.filter(function(timeout) {
          if (timeout.el === el && (options.filter == null || options.filter(timeout))) {
            dynamics2.clearTimeout(timeout.id);
            return false;
          }
          return true;
        });
    ...
    dynamics2.setTimeout = function(fn, delay) {
      return addTimeout(fn, delay * slowRatio);
    };
    dynamics2.clearTimeout = function(id) {
      return cancelTimeout(id);
    };
    dynamics2.toggleSlow = function() {
      slow = !slow;
      if (slow) {
        slowRatio = 3;
      } else {
    ...
    {
      module.exports = dynamics2;
    }
  }).call(commonjsGlobal);
});
var animate = dynamics.animate;
var bezier = dynamics.bezier;
var bounce = dynamics.bounce;
var clearTimeout$1 = dynamics.clearTimeout;
var css = dynamics.css;
export default dynamics;
var easeIn = dynamics.easeIn;
var easeInOut = dynamics.easeInOut;
var easeOut = dynamics.easeOut;
var forceWithGravity = dynamics.forceWithGravity;
var gravity = dynamics.gravity;
var linear = dynamics.linear;
var setTimeout$1 = dynamics.setTimeout;
var spring = dynamics.spring;
var stop = dynamics.stop;
var toggleSlow = dynamics.toggleSlow;
export {dynamics as __moduleExports, animate, bezier, bounce, clearTimeout$1 as clearTimeout, css, easeIn, easeInOut, easeOut, forceWithGravity, gravity, linear, setTimeout$1 as setTimeout, spring, stop, toggleSlow};
